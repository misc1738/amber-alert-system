...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'grid-glow': "radial-gradient(ellipse at top, hsl(var(--critical)/0.15), transparent 60%), radial-gradient(ellipse at bottom, hsl(var(--alert)/0.12), transparent 55%)",
      ...
      keyframes: {
        ...
        "glow": {
          "0%, 100%": { boxShadow: "0 0 24px hsl(var(--critical)/0.35)" },
          "50%": { boxShadow: "0 0 48px hsl(var(--critical)/0.7)" },
        },
      },
      animation: {
